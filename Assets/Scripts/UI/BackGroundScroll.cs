...
namespace Assets.Scripts.UI
{
    ...
    public class BackGroundScroll : MonoBehaviour
    {
        ...
        private async UniTask Scroll()
        {
            ...
            {
                _backgroundImage.uvRect = new Rect(_backgroundImage.uvRect.position + new Vector2(_xDirection * _scrollSpeed, _yDirection * _scrollSpeed) * Time.deltaTime, _uvRectSize);
